...
#
# stop_loss / take_profit: float | None. MT5's historical deal object does not
# reliably carry the protective levels of the closing order, so they are only
# filled when the related closing order can actually be retrieved
